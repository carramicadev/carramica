    ...
    if (Object.values(findErros).some((err) => err !== "")) {
      ...
      try {
        if (props?.show?.mode === "edit") {
          ...
          // console.log("Document written with ID: ",);
          enqueueSnackbar(`sukses menambahkan product ${formData?.nama}`, {
            variant: "success",
          });
    ...
    >
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {props?.show?.mode === "edit" ? "Edit Product" : "Add Produk"}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body
          style={{
        ...
        >
          <div>
            <div className="form-group">
              ...
              <Form.Control
                isInvalid={formError.sku ? true : false}
                className="input"
                type="text"
                name="sku"
                placeholder="P46YUJH"
            ...
            <div className="form-group">
              ...
              <Form.Control
                isInvalid={formError.nama ? true : false}
                className="input"
                type="text"
                name="nama"
                placeholder="Gelas"
            ...
            <Row>
              <Col sm={3}>
                <div className="form-group">
                  ...
                  <Form.Control
                    isInvalid={formError.weight ? true : false}
                    className="input"
                    type="number"
                    name="weight"
                    placeholder="200"
              ...
              <Col sm={3}>
                <div className="form-group">
                  ...
                  <Form.Control
                    isInvalid={formError.length ? true : false}
                    className="input"
                    type="number"
                    name="length"
                    placeholder="30"
              ...
              <Col sm={3}>
                <div className="form-group">
                  ...
                  <Form.Control
                    isInvalid={formError.width ? true : false}
                    className="input"
                    type="number"
                    name="width"
                    placeholder="10"
              ...
              <Col sm={3}>
                <div className="form-group">
                  ...
                  <Form.Control
                    isInvalid={formError.height ? true : false}
                    className="input"
                    type="number"
                    name="height"
                    placeholder="20"
            ...
            <div className="form-group">
              ...
              <Form.Control
                isInvalid={formError.harga ? true : false}
                className="input"
                type="number"
                name="harga"
                placeholder="10000"
            ...
            <div className="form-group">
              ...
              <Form.Control
                isInvalid={formError.stok ? true : false}
                className="input"
                type="number"
                name="stok"
                placeholder="100"
        ...
        <Modal.Footer style={{ display: "flex" }}>
          ...
          <button onClick={handleAdd} className="button button-primary">
            {props?.show?.mode === "edit" ? "Update" : "Add"}
          </button>

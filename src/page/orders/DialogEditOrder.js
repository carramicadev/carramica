...
export default function EditOrders(props) {
  ...
  const handleChange = async (e, productIndex) => {
    ...
    if (productIndex !== undefined) {
      ...
      const products = order.products.map((product, j) => {
        ...
        if (name === "discount_type" && value === "%" && product?.discount) {
          ...
          hargaAmountAfterDiscon =
            (1 - parseInt(product?.discount ? product?.discount : 0) / 100) *
            hargaAmountAfterDiscon;
        } else if (
          name === "discount_type" &&
          value === "Rp" &&
          ...
          hargaAmountAfterDiscon =
            (1 - parseInt(value ? value : 0) / 100) * hargaAmountAfterDiscon;
        ...
        return j === productIndex
          ? Array.isArray(e)
            ...
            : name === "discount_type"
            ? { ...product, [name]: value, amount: hargaAmountAfterDiscon }
            : {
                ...product,
                [name]: parseInt(value),
      ...
      const selectedObj = listService?.find?.(
      ...
      const updateOrder =
        typeof e !== "object"
          ...
          : name === "kurirService"
          ? { ...order, [name]: selectedObj, ongkir: selectedObj?.price }
          : { ...order, [name]: value };
  ...
  const addProductField = () => {
    setOrder({
      ...
      products: [
        ...order.products,
        { nama: "", quantity: "", price: "", discount: "", amount: "" },
      ],
    });
  };
      ...
      async function getService() {
        ...
        try {
          ...
          const result = await helloWorld({
            items: ordersProduct,
            origin_latitude: -6.19715,
            origin_longitude: 106.699,
        ...
        >
          <div className="orderField">
            <div className="form-group">
              ...
              <Form.Control
                isInvalid={ordersErr?.receiverName ? true : false}
                className="input"
                type="text"
                name="receiverName"
                placeholder="Nashir"
              ...
              {ordersErr?.receiverName && (
                <div class="invalid-feedback">{ordersErr?.receiverName}</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              <Form.Control
                style={{ display: "none" }}
                isInvalid={ordersErr?.receiverPhone ? true : false}
                className="input"
                type="text"
                name="receiverPhone"
              ...
              {ordersErr?.receiverPhone && (
                <div class="invalid-feedback">{ordersErr?.receiverPhone}</div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              <Form.Control
                isInvalid={ordersErr?.address ? true : false}
                as="textarea"
                rows={3}
                className="textarea"
                name="address"
              ...
              <div className="input-note">
                Contoh : Kalibata City, 92, Jl. Raya Kalibata No.12, RT.9/RW.4,
                Rawajati, Kec. Pancoran, Kota Jakarta Selatan, Daerah Khusus
                Ibukota Jakarta 12750
              </div>
              {ordersErr?.address && (
                <div class="invalid-feedback">{ordersErr?.address}</div>
              )}
            </div>
                  ...
                  <div className="productInfo">
                    <div className="form-group">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => handleChange(e, productIndex)}
                      />
                      {product?.stock && (
            ...
            {order.products.length > 1 && (
              <button
                ...
                onClick={() => deleteLastProductField()}
              >
                Delete Produk
              </button>
            )}
            ...
            <div className="form-group">
              ...
              <Form.Select
                ...
                isInvalid={ordersErr?.kurir ? true : false}
              ...
              {ordersErr?.kurir && (
                <div class="invalid-feedback">{ordersErr?.kurir}</div>
              )}
            ...
            <div className="form-group">
              ...
              <Form.Control
                onWheel={(e) => e.target.blur()}
                isInvalid={ordersErr?.ongkir ? true : false}
                className="input"
                type="number"
                name="ongkir"
                onChange={handleChange}
